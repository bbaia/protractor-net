...
namespace Protractor
{
    ...
    /// 
    /// </summary>
    public class Binding : OpenQA.Selenium.By
    {
        private object[] args;
        /// <summary>
        /// 
        ...
        public override ReadOnlyCollection<IWebElement> FindElements(ISearchContext context)
        {
            ...
            ReadOnlyCollection<IWebElement> elements = jsExecutor.ExecuteScript(ClientSideScripts.FindBindings, scriptArgs) as ReadOnlyCollection<IWebElement>;
            if (elements == null)
            {
