...
namespace Protractor
{
    ...
    public class TextArea : By
    {
        ...
        public override ReadOnlyCollection<IWebElement> FindElements(ISearchContext context)
        {
            ...
            ReadOnlyCollection<IWebElement> elements = jsExecutor.ExecuteScript(ClientSideScripts.FindTextArea, scriptArgs) as ReadOnlyCollection<IWebElement>;
            if (elements == null)
            {
